...
from task.loss import HeatmapLoss, AEloss

from constrained_pose_estimation.train_constrained_rnn import trainer as rnn_train


# from constrained_pose_estimation.test_constrain_rnn import rnn_tester as test_constrain_rnn
...
class PoseNet(nn.Module):
    ...
    def calc_loss(self, preds, keypoints=None, heatmaps=None, masks=None, separate_heatmaps=None, areas=None, im_name=None):
        dets = preds[:, :, :17]
        tags = preds[:, :, 17:34]
